...
out vec2 v_uv;
out vec3 v_frag_pos;
out vec4 v_frag_pos_directional_light_space[N_DIRECTIONAL_LIGHTS];
...
void main() {
    ...
    for (int i = 0; i < directional_lights_count; ++i) {
        v_frag_pos_directional_light_space[i] = u_directional_light_space_matrix[i] * vec4(v_frag_pos, 1.0);
    }
